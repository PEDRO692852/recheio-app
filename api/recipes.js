export default async function handler(req, res) {
  ...
  try {
    const { itemNames, excludeNames, diet, people, liked, disliked, craving, priorityItems } = req.body || {};
    if (!itemNames) {
